    ...
    return {
        ...
        init: function () {
            ...
            jQuery('#sample_1 .group-checkable').change(function () {
				...
				var linkBtn = '<input type="submit" class="btn red" value="Delete Selected">';
                jQuery(set).each(function () {
                    if (checked) {
                        $(this).attr("checked", true);
						$('#btn-field').html('');
						$('#btn-field').append(linkBtn);
                    } else {
			...
			jQuery('.checkboxes').change(function(){
				var set1 = jQuery(this).attr("data-set");
				var checked1 = jQuery(set1).is(":checked");
				var linkBtn1 = '<input type="submit" class="btn red" value="Delete Selected">';
								
				if (checked1){				
					$('#btn-field').html('');
					$('#btn-field').append(linkBtn1);					
				} else {
					$('#btn-field').html('');
				}
			});
